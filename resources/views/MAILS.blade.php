                                            ...
                                            <td bgcolor="#FFFFFF" align="center"
                                                ...
                                                <table align="center" width="90%" border="0" cellspacing="0"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <!--end logo-->
                                                        <tr>
                                                            <td height="15"><img src="{{ asset('welcome.jpg') }}"
                                                                    width="321"></td>
                                                        </tr>
                                                        <!--headline-->
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                style="font-family: 'Open Sans', Arial, sans-serif; font-size: 22px;color:#414a51;font-weight: bold;">
                                                                {{ $mail['message'] }}
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="preference-link" align="center"
                                                ...
                                                © 2023. <a href="{{ url('/') }}" title="" target="">All
                                                    Rights Reserved.
                                                </a></td>
                                        </tr>
                                        <!--end preference-->
